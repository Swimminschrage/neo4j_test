...
# -*- encoding: utf-8 -*-
# stub: neo4j_test 0.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib", "lib/neo4j_test"]
  ...
  s.files = [
    ...
    "VERSION",
    "lib/neo4j_test.rb",
    "lib/neo4j_test/java.rb",
    "lib/neo4j_test/neo4j_server.rb",
    "spec/neo4j_test_spec.rb",
    "spec/spec_helper.rb"
  ]
  s.homepage = "http://github.com/Swimminschrage/neo4j_test"
  s.licenses = ["MIT"]
